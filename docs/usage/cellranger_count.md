...
<figure markdown="span">
	![cellranger_count.smk rulegraph](https://github.com/Sika-Zheng-Lab/SnakeNgs/blob/develop/img/cellranger_count_rulegraph.svg?raw=true){ width="1000" align="center" }
</figure>
