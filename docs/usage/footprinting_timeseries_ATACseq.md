...
<figure markdown="span">
	![footprinting_timeseries_ATACseq.smk rulegraph](https://github.com/NaotoKubota/SnakeNgs/blob/develop/img/footprinting_timeseries_ATACseq_rulegraph.svg?raw=true){ width="1000" align="center" }
</figure>
